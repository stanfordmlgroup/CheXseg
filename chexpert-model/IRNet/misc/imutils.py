...
def random_scale(img, scale_range, order, target_scale=None):
    ...
    if isinstance(img, tuple):
        ...
        rescaled_img = pil_rescale(img, target_scale, order)
        # print("Rescaled Ikmage size=", rescaled_img.shape)
        return (rescaled_img, target_scale)
...
def random_crop(images, cropsize, default_values, box=None):
